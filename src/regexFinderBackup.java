...
public class regexFinderBackup
{
	public static void main(String[] args)
			throws IOException, java.io.FileNotFoundException
	{
		int i, j, e, y, t, d, v, counter = 0, temp = 0, dc = 0;
		int request = 5;
		int nodes = 7;
		int[] b = new int[nodes];
		...
		try
		{
			...
			while (scanner.hasNextLine())
			{
				...
				Pattern p2 = Pattern.compile("(w)\\w([0-9]\\d*)");
				...
				if (m.find())
				{
					...
					/*
					 * if (temp != t) counter = 0; a[t][counter] = d;
					 * a[t][counter + 1] = v; writer.write(a[t][counter] + " ");
			...
			writer1 = new BufferedWriter(
					new OutputStreamWriter(
							new FileOutputStream(
									"D:/Thesis/Primary/datacenter.txt", false),
							"utf-8"));
